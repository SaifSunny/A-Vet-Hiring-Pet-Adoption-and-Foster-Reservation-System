							...
							<div class="col-md-12">
								<div class="card-box mb-30" style="padding:20px;">
									...
									<table class="table" style="font-size: 14px;text-align:center;">
										...
										<tbody>
											<?php 
												$sql = "SELECT * FROM fosters WHERE `status`='0'";
												$result = mysqli_query($conn, $sql);
												if($result){
											...
											<tr>
												...
												<td><a href="admin_foster_verification.php?id=<?php echo $id?>"
														class="btn btn-success" style="padding:8px;margin-bottom:10px;"><i
															class="fa fa-check"></i></a>
															<a href="admin_delete_foster.php?id=<?php echo $id?>"
