...
if (isset($_POST['submit'])) {
	...
	$date = date("Y-m-d h:i:sa");
		...
		VALUES ($post_id, '$img', '$fostername', '$comment', '$date', '1',$user_id)";
        $result = mysqli_query($conn, $sql);
        if($result){
												...
												<li>
														...
														<footer>
															<div class="d-flex">
																...
																<div style="padding-left:30px;">
																	<p><a href="foster_commenter_profile.php?commenter_name=<?php echo $commenter_name?>&role=<?php echo $role?>"><?php echo $commenter_name?></a><br>
													...
													<ul>
														<li>
															...
															?>
															<form
																action="foster_reply.php?comment_id=<?php echo $comment_id?>&post_id=<?php echo $post_id?>"
																method="POST">
																<div class="d-flex">
							...
							<div class="col-md-4 col-sm-12">
								...
								<div class="card-box mb-30">
									...
									<div class="list-group">
										<a href="foster_posts.php?category=Adoption"
										...
										<a href="foster_posts.php?category=Foster"
										...
										<a href="foster_posts.php?category=Petcare"
										...
										<a href="foster_posts.php?category=Pethealth"
											class="list-group-item d-flex align-items-center justify-content-between">Pet
											Health
											<span
