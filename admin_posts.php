										...
										<li>
											<div class="row no-gutters">
												...
												<div class="col-lg-8 col-md-12 col-sm-12">
													<div class="blog-caption d-flex justify-content-between">
														<div class="">
															...
															<div class="blog-by">
																...
																<div class="pt-10">
																	<a href="admin_post_details.php?post_id=<?php echo $post_id?>"
														...
														<div>
															<a href="admin_delete_post.php?id=<?php echo $post_id?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
														</div>
													</div>
												</div>
											</div>
							...
							<div class="col-md-4 col-sm-12">
								...
								<div class="card-box mb-30">
									...
									<div class="list-group">
										<a href="admin_posts_sort.php?category=Adoption"
										...
										<a href="admin_posts_sort.php?category=Foster"
										...
										<a href="admin_posts_sort.php?category=Petcare"
										...
										<a href="admin_posts_sort.php?category=Pethealth"
											class="list-group-item d-flex align-items-center justify-content-between">Pet
											Health
											<span
