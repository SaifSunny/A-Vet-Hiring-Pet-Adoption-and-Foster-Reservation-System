...
if(isset($_POST['submit'])){
    ...
    if (strlen($p) > 5) {
        ...
        if (!$query_run->num_rows > 0) {
            ...
            $query = "SELECT * FROM fosters WHERE nid = '$nid'";
            $query_run = mysqli_query($conn, $query);
            if(!$query_run->num_rows > 0){
                ...
                if( in_array($imageFileType,$extensions_arr) ){
                    ...
                    if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                        ...
                        $query2 = "INSERT INTO fosters(fostername,email,`password`,firstname,lastname,contact,gender,birthday,blood_group, image, `address`, city, zip,nid,status)
                        VALUES ('$fostername', '$email', '$password', '$firstname', '$lastname', '$contact', '$gender', '$birthday', '$blood_group', '$name', '$address', '$city', '$zip', '$nid','1')";
							...
							<div class="row" style="padding-top:30px;color:#222;">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="col-md-12" style="width: 250px; height: 250px;">
														<img src="./images/fosters/user.png" width="100%"
								...
								<div class="col-md-8">
									<div class="card mx-auto"
										...
										<h4 class="card-title" style="color:#222;">Add Foster</h4>
											...
											<div class="col-md-6">
												...
												<div class="col-md-6">
													<div class="form-group" style="padding:10px">
														...
														<input type="text" class="form-control" name="fostername"
															id="fostername" placeholder="Username">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group" style="padding:10px">
