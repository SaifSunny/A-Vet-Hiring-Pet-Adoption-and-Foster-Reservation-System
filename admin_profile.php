...
if (isset($_POST['submit_img'])) {
    ...
    if( in_array($imageFileType,$extensions_arr) ){
        ...
        if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
            ...
            // Update Record
            $query2 = "UPDATE `admin` SET `image`='$name' WHERE adminname='$adminname'";
            $query_run2 = mysqli_query($conn, $query2);

            $query3 = "UPDATE `recent` SET `image`='$name' WHERE `name`='$adminname'";
...
if (isset($_POST['submit'])) {
    ...
    $cls="";
        ...
        `address`='$address', city='$city', zip='$zip' WHERE adminname='$adminname'";
        $query_run2 = mysqli_query($conn, $query2);
							...
							<div class="row ">
								<div class="col-md-12" style="padding-top:30px;">
									<div class="d-flex justify-content-center" style="width: 200px; height: 200px;">
										<img src="./images/admin/<?php echo $image;?>" width="100%" height="100%"
