				...
				<div class="col-xl-12 mb-30">
					<div class="card-box height-100-p pd-20">
						...
						<table class="table" style="font-size: 14px;">
							...
							<tbody>
								<?php 
									$sql = "SELECT * FROM vet_appointment WHERE `user_id`=$foster_id";
									$result = mysqli_query($conn, $sql);
									if($result){
								...
								<tr>
									...
									<td><a href="foster_delete_vet_appointment.php?id=<?php echo $appointment_id ?>" class="btn btn-danger" style="padding:8px;"><i class="fa fa-trash"></i></a>
									</td>
